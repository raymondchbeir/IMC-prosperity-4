...
def get_upload_layout():
    return html.Div(
        [
            ...
            html.Div(id="market-overview-container"),
        ]
    )
...
def register_upload_callbacks(app):
    ...
    def handle_upload(contents_list, filenames):
        ...
        try:
            with tempfile.TemporaryDirectory() as tmpdir:
                ...
                market_layout = build_market_overview_layout()
                ...
                return status, summary, market_layout, store_data
            ...
            return error_box, html.Div(), html.Div(), None
    ...
    def update_market_graphs(store_data, selected_product, selected_round, selected_day, compare_days_value, compare_products, timestamp_range):
        ...
        return (
            ...
            make_trade_volume_figure(trades_df, prices_df),
            make_imbalance_figure(prices_df),
            make_returns_volatility_figure(prices_df),
            make_book_heatmap_figure(prices_df),
            make_cross_product_figure(cross_df, selected_product, compare_products),
        )
    ...
    def download_filtered_prices(n_clicks, store_data, selected_product, selected_round, selected_day, compare_days_value, timestamp_range):
    ...
    def download_filtered_trades(n_clicks, store_data, selected_product, selected_round, selected_day, compare_days_value, timestamp_range):
        if not n_clicks or not store_data:
            raise PreventUpdate
